/* $Id: NewProjectWizardDialog.java 138 2009-05-09 00:11:15Z flavio.garcia $
 * 
...
public class NewProjectWizardDialog extends AbstractWizardDialog {
    ...
    private void createCenterPane() {
    	...
    	centerPanel.setLayout( new MigLayout( "fillx", 
    			"[right]rel[grow,fill]" ) );
    ...
    /**
     * Update the tree loading project data form MainApp. 
     */
